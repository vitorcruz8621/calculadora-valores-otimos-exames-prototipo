class HemogramaUtils {
  ...
  static avaliarHemograma(dados, sexo = "homens") {
    ...
    if (dados.hemacias !== undefined) {
      resultado.hemacias = this.avaliar(
        dados.hemacias,
        this.referencia.hemacias[sexo]
      );
    }

    // Hemoglobina
    if (dados.hemoglobina !== undefined) {
      resultado.hemoglobina = this.avaliar(
        dados.hemoglobina,
        this.referencia.hemoglobina[sexo]
      );
    }

    // Hematócrito
    if (dados.hematocrito !== undefined) {
      resultado.hematocrito = this.avaliar(
        dados.hematocrito,
        this.referencia.hematocrito[sexo]
      );
    }
